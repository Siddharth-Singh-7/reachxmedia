...
export function CardStack<T extends CardStackItem>({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="pointer-events-none absolute inset-x-0 top-6 mx-auto h-48 w-[70%] rounded-full bg-primary/10 blur-3xl"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-40 w-[76%] rounded-full bg-primary/20 blur-3xl"
          aria-hidden="true"
        />
        <div
